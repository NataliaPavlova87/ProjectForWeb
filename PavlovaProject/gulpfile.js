...
gulp.task('default', gulp.series('clean', gulp.parallel('html', 'sass', 'js:es6', 'js:babel', 'pug', 'sass:watch', 'html:watch', 'js:watch', 'pug:watch', 'css:watch', 'css','json', 'img', 'server')));